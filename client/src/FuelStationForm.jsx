        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 mb-8 border border-gray-100">
          <div className="flex items-center justify-between flex-wrap">
            ...
            <div className="flex items-center mb-4 md:mb-0">
              <div className="w-16 h-16 bg-gradient-to-br from-blue-600 to-indigo-700 rounded-2xl flex items-center justify-center shadow-md mr-6">
                <Fuel className="w-5 h-5 md:w-8 md:h-8 text-white" />
              </div>

              <div>
                <h1 className="text-3xl font-bold text-gray-900">Ashish Patel</h1>
                <div className="flex items-center text-gray-600 mt-1">
                  <Building className="w-4 h-4 mr-2 text-blue-600" />
                  <span>Retail Outlet: South Nagpur ABCD Petrol Pump</span>
                </div>
              </div>
            </div>
